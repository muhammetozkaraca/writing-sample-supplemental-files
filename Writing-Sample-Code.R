...
ras3_state <- readxl::read_excel("/Users/muhammetozkaraca/Desktop/PhD Application Package/Writing-Sample/supplemental-files/datasets/Religion-and-State.XLSX")     
